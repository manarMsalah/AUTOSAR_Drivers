 ...
 *  6. the mode of pin --> DIO, DIO_GPT, ADC, CAN, SSI, NMI, I2C, UART, ANALOG COMPARATOR, CORE, QEI, JTAG, USB or PWM
 *  7. the internal resistor --> PULL_UP or  PULL_DOWN in case direction is input.
